...
import { globalStyles, inputStyles, spacing, typography, colors } from '../styles/globalStyles'
    ...
    <SafeAreaView style={globalStyles.safeContainer}>
      <View style={globalStyles.screenContainer}>
        ...
        >
          ...
          <Text style={[typography.body, { marginTop: spacing.md, color: colors.darkGray }]}>
